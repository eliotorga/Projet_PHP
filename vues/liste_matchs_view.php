...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/liste_matchs.css">
    ...
    <div class="page-container">
                ...
                <div class="match-card">
                    ...
                    <div class="match-body">
                        <div class="match-teams">
                            <div class="team-home">
                                <div class="team-logo"><i class="fas fa-home"></i></div>
                                <div class="team-name">
                            ...
                            <div class="match-score">
                                <?php if ($m['etat'] === 'JOUE' && $resultatSaisi): ?>
                                    ...
                                    <span class="match-status <?= $m['resultat'] ?>"><?= $m['resultat'] ?></span>
                                <?php else: ?>
                                    <div class="score">-</div>
                                    <span class="match-status <?= $etatAffichage ?>"><?= $etatLibelle ?></span>
                                <?php endif; ?>
                            </div>
        ...
        <div class="workflow-container">
            ...
            <div class="workflow-steps">
                ...
                <div class="workflow-step">
                    <div class="step-icon"><i class="fas fa-futbol"></i></div>
